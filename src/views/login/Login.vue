<template>
  <div class="wrapper">
    ...
    <div class="wrapper__input">
      <input v-model="username" class="wrapper__input__content" type="text" placeholder="请输入手机号">
    </div>
    <div class="wrapper__input">
      <input v-model="password" class="wrapper__input__content" type="password" placeholder="请输入密码">
    </div>
